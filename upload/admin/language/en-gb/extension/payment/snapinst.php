<?php
// Heading
$_['heading_title']       = '<span style="border-radius:2px;color:#fff;background:#8fbb6c;padding:2px 5px;">HP</span> Snap Installment';

$_['heading_title2']      = 'Snap Installment';
...
$_['help_snap_challenge_mapping']  = 'Change to the following order status once the payment pending/failed';
